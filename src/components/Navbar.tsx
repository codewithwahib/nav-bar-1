...
export default function Navbar() {
  return (
    <Popover className='  mx-auto flex items-center border-b-2 px-6 py-2 h-16 bg-blue-500 text-white ' >
        <h1 className=" font-bold text-xl ">Hassan</h1>
        <div className=" grow ">
            ...
            <Popover.Panel className='absolute inset-x-0 top-0 origin-top-right transform p-2 transition md:hidden ' >
              <div className=" rounded-lg bg-blue-500 shadow-lg ring-1 ring-black ring-opacity-5 divide-y-2 divide-gray-50  ">
                <div className=" px-5 pt-5 pb-6 ">
                  <div className=" flex items-center justify-between ">
                    <h1 className=' font-bold ' >Hassan</h1>
                    <div className=" mr-2 ">
                      <Popover.Button className=' inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 ' >
